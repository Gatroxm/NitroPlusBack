...
const initModels = (sequelize = connection.default) => {
    ...
    var tb_coches = _tb_coches(sequelize, sequelize_1.DataTypes);
    var tb_coches_sim = _tb_coches_sim(sequelize, sequelize_1.DataTypes);
    var tb_cod_plataforma = _tb_cod_plataforma(sequelize, sequelize_1.DataTypes);
    ...
    var tb_equipos = _tb_equipos(sequelize, sequelize_1.DataTypes);
    var tb_equipos_sim = _tb_equipos_sim(sequelize, sequelize_1.DataTypes);
    var tb_estado_carrera = _tb_estado_carrera(sequelize, sequelize_1.DataTypes);
    var tb_estado_clasificatorios = _tb_estado_clasificatorios(sequelize, sequelize_1.DataTypes);
    var tb_estado_general = _tb_estado_general(sequelize, sequelize_1.DataTypes);
    var tb_estado_inscripcion = _tb_estado_inscripcion(sequelize, sequelize_1.DataTypes);
    var tb_estado_penalizaciones = _tb_estado_penalizaciones(sequelize, sequelize_1.DataTypes);
    var tb_estado_reportes = _tb_estado_reportes(sequelize, sequelize_1.DataTypes);
    var tb_estado_ticket = _tb_estado_ticket(sequelize, sequelize_1.DataTypes);
    var tb_estado_torneos = _tb_estado_torneos(sequelize, sequelize_1.DataTypes);
    var tb_etapas_calendario = _tb_etapas_calendario(sequelize, sequelize_1.DataTypes);
    var tb_eventos_clasificatorios = _tb_eventos_clasificatorios(sequelize, sequelize_1.DataTypes);
    var tb_evidencias_reportes = _tb_evidencias_reportes(sequelize, sequelize_1.DataTypes);
    var tb_formato_carrera = _tb_formato_carrera(sequelize, sequelize_1.DataTypes);
    var tb_fotos_pilotos = _tb_fotos_pilotos(sequelize, sequelize_1.DataTypes);
    var tb_gravedad_sancion = _tb_gravedad_sancion(sequelize, sequelize_1.DataTypes);
    var tb_grupo_coches_personalizado = _tb_grupo_coches_personalizado(sequelize, sequelize_1.DataTypes);
    var tb_grupo_equipos = _tb_grupo_equipos(sequelize, sequelize_1.DataTypes);
    var tb_historial_vueltas = _tb_historial_vueltas(sequelize, sequelize_1.DataTypes);
    var tb_ident_pos = _tb_ident_pos(sequelize, sequelize_1.DataTypes);
    var tb_ident_pos_sim_preq = _tb_ident_pos_sim_preq(sequelize, sequelize_1.DataTypes);
    var tb_indicador_cumplimiento_torneo = _tb_indicador_cumplimiento_torneo(sequelize, sequelize_1.DataTypes);
    var tb_info_calculo_resultados = _tb_info_calculo_resultados(sequelize, sequelize_1.DataTypes);
    var tb_info_clasificatorios = _tb_info_clasificatorios(sequelize, sequelize_1.DataTypes);
    var tb_inscripcion_clasificatorios = _tb_inscripcion_clasificatorios(sequelize, sequelize_1.DataTypes);
    var tb_inscripciones = _tb_inscripciones(sequelize, sequelize_1.DataTypes);
    var tb_insignias_discord = _tb_insignias_discord(sequelize, sequelize_1.DataTypes);
    var tb_insignias_pilotos = _tb_insignias_pilotos(sequelize, sequelize_1.DataTypes);
    var tb_involucrados_sanciones = _tb_involucrados_sanciones(sequelize, sequelize_1.DataTypes);
    var tb_licencias_pilotos = _tb_licencias_pilotos(sequelize, sequelize_1.DataTypes);
    var tb_licencias_variacion = _tb_licencias_variacion(sequelize, sequelize_1.DataTypes);
    var tb_ligas = _tb_ligas(sequelize, sequelize_1.DataTypes);
    var tb_marcas_coches = _tb_marcas_coches(sequelize, sequelize_1.DataTypes);
    var tb_marcas_mando = _tb_marcas_mando(sequelize, sequelize_1.DataTypes);
    var tb_mensajes_ticket = _tb_mensajes_ticket(sequelize, sequelize_1.DataTypes);
    var tb_metodologias_clasificatorio = _tb_metodologias_clasificatorio(sequelize, sequelize_1.DataTypes);
    var tb_neumaticos = _tb_neumaticos(sequelize, sequelize_1.DataTypes);
    var tb_neumaticos_sim = _tb_neumaticos_sim(sequelize, sequelize_1.DataTypes);
    var tb_nombre_grupo_coches_personalizado = _tb_nombre_grupo_coches_personalizado(sequelize, sequelize_1.DataTypes);
    var tb_nombre_grupo_equipos = _tb_nombre_grupo_equipos(sequelize, sequelize_1.DataTypes);
    var tb_notificaciones = _tb_notificaciones(sequelize, sequelize_1.DataTypes);
    var tb_notificaciones_discord = _tb_notificaciones_discord(sequelize, sequelize_1.DataTypes);
    var tb_opcion_clasificatorios_torneo = _tb_opcion_clasificatorios_torneo(sequelize, sequelize_1.DataTypes);
    var tb_opciones_respuesta = _tb_opciones_respuesta(sequelize, sequelize_1.DataTypes);
    var tb_orientacion_pista = _tb_orientacion_pista(sequelize, sequelize_1.DataTypes);
    var tb_paises = _tb_paises(sequelize, sequelize_1.DataTypes);
    var tb_parrilla_calendario = _tb_parrilla_calendario(sequelize, sequelize_1.DataTypes);
    var tb_participaciones = _tb_participaciones(sequelize, sequelize_1.DataTypes);
    var tb_penalizacion_sanciones = _tb_penalizacion_sanciones(sequelize, sequelize_1.DataTypes);
    var tb_pilotos = _tb_pilotos(sequelize, sequelize_1.DataTypes);
    var tb_pilotos_id_sim = _tb_pilotos_id_sim(sequelize, sequelize_1.DataTypes);
    var tb_pilotos_liga = _tb_pilotos_liga(sequelize, sequelize_1.DataTypes);
    var tb_pilotos_penalizados = _tb_pilotos_penalizados(sequelize, sequelize_1.DataTypes);
    var tb_pistas = _tb_pistas(sequelize, sequelize_1.DataTypes);
    var tb_pistas_sim = _tb_pistas_sim(sequelize, sequelize_1.DataTypes);
    var tb_pistas_variantes = _tb_pistas_variantes(sequelize, sequelize_1.DataTypes);
    var tb_plantillas_graficos = _tb_plantillas_graficos(sequelize, sequelize_1.DataTypes);
    var tb_plataforma = _tb_plataforma(sequelize, sequelize_1.DataTypes);
    var tb_pregunta_inscripcion = _tb_pregunta_inscripcion(sequelize, sequelize_1.DataTypes);
    var tb_puntos = _tb_puntos(sequelize, sequelize_1.DataTypes);
    var tb_records_pistas = _tb_records_pistas(sequelize, sequelize_1.DataTypes);
    var tb_records_por_piloto = _tb_records_por_piloto(sequelize, sequelize_1.DataTypes);
    var tb_reparto_puntos = _tb_reparto_puntos(sequelize, sequelize_1.DataTypes);
    var tb_repeticiones = _tb_repeticiones(sequelize, sequelize_1.DataTypes);
    var tb_reportes_comisarios = _tb_reportes_comisarios(sequelize, sequelize_1.DataTypes);
    var tb_resultados = _tb_resultados(sequelize, sequelize_1.DataTypes);
    var tb_resultados_clasificatorios = _tb_resultados_clasificatorios(sequelize, sequelize_1.DataTypes);
    var tb_resultados_eventos_clasificatorios = _tb_resultados_eventos_clasificatorios(sequelize, sequelize_1.DataTypes);
    var tb_resultados_subtramos = _tb_resultados_subtramos(sequelize, sequelize_1.DataTypes);
    var tb_resultados_manual = _tb_resultados_manual(sequelize, sequelize_1.DataTypes);
    var tb_rol_involucrados = _tb_rol_involucrados(sequelize, sequelize_1.DataTypes);
    var tb_roles = _tb_roles(sequelize, sequelize_1.DataTypes);
    var tb_roles_discord_pilotos = _tb_roles_discord_pilotos(sequelize, sequelize_1.DataTypes);
    var tb_roles_pilotos = _tb_roles_pilotos(sequelize, sequelize_1.DataTypes);
    var tb_sesiones = _tb_sesiones(sequelize, sequelize_1.DataTypes);
    var tb_sim_plat_codplat = _tb_sim_plat_codplat(sequelize, sequelize_1.DataTypes);
    var tb_sim_version = _tb_sim_version(sequelize, sequelize_1.DataTypes);
    var tb_simcodplat_torneo = _tb_simcodplat_torneo(sequelize, sequelize_1.DataTypes);
    var tb_simulador = _tb_simulador(sequelize, sequelize_1.DataTypes);
    var tb_sistema_puntos = _tb_sistema_puntos(sequelize, sequelize_1.DataTypes);
    ...
    var tb_tipo_fotos = _tb_tipo_fotos(sequelize, sequelize_1.DataTypes);
    var tb_tipo_licencias = _tb_tipo_licencias(sequelize, sequelize_1.DataTypes);
    var tb_tipo_mando = _tb_tipo_mando(sequelize, sequelize_1.DataTypes);
    var tb_tipo_notificacion = _tb_tipo_notificacion(sequelize, sequelize_1.DataTypes);
    var tb_tipo_penalizacion = _tb_tipo_penalizacion(sequelize, sequelize_1.DataTypes);
    var tb_tipo_piloto = _tb_tipo_piloto(sequelize, sequelize_1.DataTypes);
    var tb_tipo_tickets = _tb_tipo_tickets(sequelize, sequelize_1.DataTypes);
    var tb_tipo_torneo = _tb_tipo_torneo(sequelize, sequelize_1.DataTypes);
    var tb_tipo_variacion_rank = _tb_tipo_variacion_rank(sequelize, sequelize_1.DataTypes);
    var tb_tipos_graficos = _tb_tipos_graficos(sequelize, sequelize_1.DataTypes);
    ...
    var tb_control_digitacion_resultados = _tb_control_digitacion_resultados(sequelize, sequelize_1.DataTypes);
    var tb_ingreso_sanciones = _tb_ingreso_sanciones(sequelize, sequelize_1.DataTypes);
    var tb_control_sanciones = _tb_control_sanciones(sequelize, sequelize_1.DataTypes);
...
module.exports = exports.initModels;
module.exports.initModels = exports.initModels;
module.exports.default = exports.initModels;
