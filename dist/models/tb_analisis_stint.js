...
module.exports = function(sequelize, DataTypes) {
  return sequelize.define('tb_analisis_stint', {
    id: {
      autoIncrement: true,
    ...
    promDesgasteLlantasVuelta: {
      type: DataTypes.DECIMAL(6,2),
      allowNull: true
    },
    finCombustibleTanque: {
      type: DataTypes.DECIMAL(6,2),
      allowNull: true
    },
    inicioCombustibleTanque: {
      type: DataTypes.DECIMAL(6,2),
      allowNull: true
    },
    promedioConsumoComb: {
