...
const tablaResultados = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    ...
    try {
        const resultados = yield models.tb_fotos_pilotos.sequelize.query(query, {
...
exports.tablaResultados = tablaResultados;
const InsertTbRepeticiones = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { idCalendario, idPiloto, segBanderaVerde, link_video, observaciones } = req.body;
    try {
        const insert = yield models.tb_repeticiones.create({
            idCalendario,
            idPiloto,
            segBanderaVerde,
            link_video,
...
exports.InsertTbRepeticiones = InsertTbRepeticiones;
const tblPosiciones = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    ...
    try {
        const posiciones = yield models.tb_tabla_posiciones.sequelize.query(query, {
            type: sequelize_1.QueryTypes.SELECT,
        });
...
exports.tblPosiciones = tblPosiciones;
const getPilotosParticipantes = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    ...
    try {
        const pilotosParticipantes = yield models.tb_reportes_comisarios.sequelize.query(query, {
            type: sequelize_1.QueryTypes.SELECT,
        });
...
exports.getPilotosParticipantes = getPilotosParticipantes;
const GuardadoReporte = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    let idReporte = "";
    let involucradoSancion = "";
    const respuestas = [];
    const { idDivision, idCalendario, idPiloto, idPilotoDenunciado, descripcion, evidencia, noVuelta, } = req.body;
    try {
        const reportesSomisarios = yield models.tb_reportes_comisarios.create({
        ...
        if (reportesSomisarios) {
            ...
            const involicradosSanciones1 = yield models.tb_involucrados_sanciones.create({
                idReporte: idReporte,
                idPiloto: idPilotoDenunciado,
                idRolInvolucrado: 2,
            });
            respuestas.push(involicradosSanciones1);
            const involicradosSanciones2 = yield models.tb_involucrados_sanciones.create({
                idReporte: idReporte,
                idPiloto: idPiloto,
                idRolInvolucrado: 1,
            });
            if (involicradosSanciones2) {
                ...
                const evidenciasReportes = yield models.tb_evidencias_reportes.create({
                    idInvolucradoSancion: involucradoSancion,
                    linkEvidencia: evidencia,
                });
                respuestas.push(evidenciasReportes);
                const descargosInvolucrados = yield models.tb_descargos_involucrados.create({
                    idInvolucradoSancion: involucradoSancion,
...
exports.GuardadoReporte = GuardadoReporte;
const getTblaRepeticiones = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    ...
    try {
        const Reportes = yield models.tb_resultados.sequelize.query(query, {
            type: sequelize_1.QueryTypes.SELECT,
        });
...
exports.getTblaRepeticiones = getTblaRepeticiones;
const modalInformacionGeneral = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    const response = [];
    ...
    try {
        const informacionGeneral = yield models.tb_reportes_comisarios.sequelize.query(query, {
            type: sequelize_1.QueryTypes.SELECT,
        });
        response.push({ informacionGeneral: informacionGeneral });
        const involucrados = yield models.tb_reportes_comisarios.sequelize.query(query2, {
            type: sequelize_1.QueryTypes.SELECT,
        });
        response.push({ involucrados: involucrados });
        const descargos = yield models.tb_reportes_comisarios.sequelize.query(query3, {
            type: sequelize_1.QueryTypes.SELECT,
        });
        response.push({ descargos: descargos });
        const evicencias = yield models.tb_reportes_comisarios.sequelize.query(query4, {
            type: sequelize_1.QueryTypes.SELECT,
        });
...
exports.modalInformacionGeneral = modalInformacionGeneral;
const InsertApelacionAclaracion = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const rsparray = [];
    ...
    try {
        ...
        const ervidencia = yield models.tb_evidencias_reportes.create({
            idInvolucradoSancion: idInvolucradoSancion,
...
exports.InsertApelacionAclaracion = InsertApelacionAclaracion;
const confirmacion = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { idDivision, idCalendario, idCategoriaPiloto, idTipoPiloto, idPiloto, idCoche, idEquipo, estaConfirmado, } = req.body;
    try {
        const buscaPiloto = yield models.tb_parrilla_calendario.findOne({
            where: {
                idCalendario: idCalendario,
                idPiloto: idPiloto,
            },
        ...
        if (buscaPiloto) {
            ...
            const confirmacion = yield models.tb_parrilla_calendario.create({
...
const tablaConfirmados = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
...
exports.tablaConfirmados = tablaConfirmados;
const InfoTorneo = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const response = [];
    const { id } = req.params;
    ...
    const infoTorneoDivision = yield models.tb_torneos.sequelize.query(query1, {
        type: sequelize_1.QueryTypes.SELECT,
    });
    response.push({ info: infoTorneoDivision });
    const infoReglas = yield models.tb_reglas_torneos.sequelize.query(query2, {
        type: sequelize_1.QueryTypes.SELECT,
    });
...
const getSistemaDePuntosMasInfo = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
