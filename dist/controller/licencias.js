...
exports.getTorneos = exports.getTiemposActuales = exports.InsertInscripcion = exports.getCalendarioLicencias = void 0;
const sequelize_1 = require("sequelize");
const { sequelize } = require("sequelize");
const init_models_1 = require("../models/init-models");
const models = (0, init_models_1.initModels)(sequelize);
const getCalendarioLicencias = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    ...
    try {
        const calendario = yield models.tb_calendario_clasificatorios.sequelize.query(query, {
...
exports.getCalendarioLicencias = getCalendarioLicencias;
const InsertInscripcion = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { idCalendario, idSimPiloto, idPiloto } = req.body;
    const inscripción = yield models.tb_inscripcion_clasificatorios.create({
...
exports.InsertInscripcion = InsertInscripcion;
const getTiemposActuales = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const tiempos = yield models.tb_resultados_eventos_clasificatorios.sequelize.query(query, {
            type: sequelize_1.QueryTypes.SELECT,
        });
        return res.json({
            ok: true,
...
exports.getTiemposActuales = getTiemposActuales;
const getTorneos = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const torneos = yield models.tb_resultados_eventos_clasificatorios.sequelize.query(query, {
            type: sequelize_1.QueryTypes.SELECT,
        });
        return res.json({
            ok: true,
